            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong>DN{{ str_pad($d->donation_id, 5, '0', STR_PAD_LEFT) }}</strong></td>
                            <td>
                            ...
                            <td><span class="badge bg-light text-dark border px-3 py-2 rounded-pill">{{ $d->payment_mode }}</span></td>
